...
export const TRAININGS: Training[] = [
  {
    ...
    '</p>\n' +
    '<p class="tz-sub-header">За время тренинга участники научатся:</p>\n' +
    ...
    '</p>\n' +
    '<p class="tz-sub-header">Структура тренинга:</p>\n' +
    ...
    cost: {
      company:
        {
          consistTitle: 'В стоимость проведения двухдневного тренинга “Основные управленческие навыки” для корпоративных Клиентов может опционно входить:',
          consist: ['Ряд мероприятий предтренинговой диагностики', 'Адаптация программы и материалов тренинга под специфику бизнеса Клиента', 'Проведение тренинга бизнес-тренером компании “Тезаурус”', 'Предоставление отчетности и обратной связи по итогам проведения тренинга', 'Ряд посттренинговых мероприятий', 'Комплект информационных материалов по теме тренинга для каждого участника'],
  ...
  },
  {
    ...
    cost: {
      company:
        {
          consistTitle: 'В стоимость проведения тренинга “Активный поиск клиентов по телефону” для корпоративных Клиентов может опционно входить:',
          consist: ['Ряд мероприятий предтренинговой диагностики', 'Адаптация программы и материалов тренинга под специфику бизнеса Клиента', 'Проведение тренинга бизнес-тренером компании “Тезаурус”', 'Предоставление отчетности и обратной связи по итогам проведения тренинга', 'Ряд посттренинговых мероприятий', 'Комплект информационных материалов по теме тренинга для каждого участника'],
          sum: 'Для уточнения стоимости тренинга свяжитесь с нашим консультантом'
        },
  ...
  },
  {
    ...
    cost: {
      company:
        {
          consistTitle: 'В стоимость проведения двухдневного тренинга “Технологии продаж в торговом зале” для корпоративных Клиентов может опционно входить:',
          consist: ['Ряд мероприятий предтренинговой диагностики', 'Адаптация программы и материалов тренинга под специфику бизнеса Клиента', 'Проведение тренинга бизнес-тренером компании “Тезаурус”', 'Предоставление отчетности и обратной связи по итогам проведения тренинга', 'Ряд посттренинговых мероприятий', 'Комплект информационных материалов по теме тренинга для каждого участника'],
          sum: 'Для уточнения стоимости тренинга свяжитесь с нашим консультантом'
        }
    }
  },
  {
    ...
    img: '4',
    title: 'Тренинг',
    subTitle: '«Управление распределенными командами»',
    audience: {
      text: 'Для руководителей',
      img: 'manager',
    },
    description: [
      'Руководители начального и среднего звена, имеющие в своем подчинении удаленные и гибридные команды'
    ],
    preview: '<p>За время тренинга участники научатся:</p>\n' +
      '<p>Как поддерживать вовлеченность и корпоративную культуру в распределенной команде; Какие инструменты использовать для эффективной коммуникации без перегрузки сотрудников; Как выявлять и предотвращать выгорание у удаленных специалистов; Какие KPI и метрики помогут объективно оценивать продуктивность; Как проводить результативные онлайн-совещания и принимать решения асинхронно; Как адаптировать стиль лидерства под разные часовые пояса и культурные особенности; Какие технологии (от CRM до ИИ-ассистентов) стоит внедрить для автоматизации контроля\n' +
      '</p>',
    text: '<p>\n' +
      '  35% времени тренинга: теоретический материал<br>65% времени тренинга: практические упражнения, направленные на отработку навыков обучающихся\n' +
      '</p>\n' +
      '<p class="tz-sub-header">Чему научатся руководители после участия в тренинге:</p>\n' +
      '<p>Как поддерживать вовлеченность и корпоративную культуру в распределенной команде<br>\n' +
      '  Какие инструменты использовать для эффективной коммуникации без перегрузки сотрудников<br>\n' +
      '  Как выявлять и предотвращать выгорание у удаленных специалистов<br>\n' +
      '  Какие KPI и метрики помогут объективно оценивать продуктивность<br>\n' +
      '  Как проводить результативные онлайн-совещания и принимать решения асинхронно<br>\n' +
      '  Как адаптировать стиль лидерства под разные часовые пояса и культурные особенности<br>\n' +
      '  Какие технологии (от CRM до ИИ-ассистентов) стоит внедрить для автоматизации контроля<br>\n' +
      '</p>\n' +
      '<p class="tz-sub-header">Структура тренинга:</p>\n' +
      '<p>1. Основы управления распределенными командами</p>\n' +
      '<ul>\n' +
      '  <li>Тренды и вызовы удаленной работы: статистика и кейсы\n' +
      '  <li>Разница между управлением офисными и удаленными сотрудниками\n' +
      '  <li>Модели распределенных команд (гибридная, полностью удаленная, «кочующие» сотрудники)\n' +
      '  <li>Роль руководителя в digital-среде: от контролера к координатору\n' +
      '</ul>\n' +
      '<p>2. Коммуникация и вовлеченность</p>\n' +
      '<ul>\n' +
      '  <li>Инструменты для ежедневной коммуникации\n' +
      '  <li>Как избежать «переписки ради переписки» и информационного шума\n' +
      '  <li>Форматы онлайн-встреч: от стендапов до ретроспектив\n' +
      '  <li>Создание и поддержание корпоративной культуры на расстоянии\n' +
      '  <li>Личный бренд руководителя в удаленном формате\n' +
      '</ul>\n' +
      '<p>3. Мотивация и продуктивность</p>\n' +
      '<ul>\n' +
      '  <li>Системы мотивации для удаленных сотрудников\n' +
      '  <li>Как измерять продуктивность без микроменеджмента\n' +
      '  <li>Геймификация и челленджи для вовлечения команды\n' +
      '  <li>Работа с прокрастинацией и дисциплиной\n' +
      '  <li>Баланс работы и личной жизни в удаленке\n' +
      '</ul>\n' +
      '<p>4. Технологии и безопасность</p>\n' +
      '<ul>\n' +
      '  <li>Обзор digital-инструментов для управления проектами\n' +
      '  <li>Автоматизация рутинных процессов\n' +
      '  <li>Кибербезопасность: как защитить данные в распределенной команде\n' +
      '  <li>Аналитика и дашборды для контроля работы\n' +
      '</ul>\n' +
      '<p>5. Конфликты и кризисные ситуации</p>\n' +
      '<ul>\n' +
      '  <li>Типичные конфликты в удаленных командах и способы их разрешения\n' +
      '  <li>Как проводить сложные разговоры онлайн\n' +
      '  <li>Действия при потере ключевого сотрудника\n' +
      '  <li>Адаптация новичков в удаленном формате\n' +
      '  <li>План действий при сбоях в коммуникации\n' +
      '</ul>',
    info:
      {
        online: false,
    ...
    cost: {
      company:
        {
          consistTitle: 'В стоимость проведения двухдневного тренинга «Управление распределенными командами» для корпоративных Клиентов может опционно входить:',
          consist: [
            'Ряд мероприятий предтренинговой диагностики',
            'Адаптация программы и материалов тренинга под специфику бизнеса Клиента',
            'Проведение тренинга бизнес-тренером компании “Тезаурус”',
            'Предоставление отчетности и обратной связи по итогам проведения тренинга',
            'Ряд посттренинговых мероприятий',
            'Комплект информационных материалов по теме тренинга для каждого участника',
          ],
          sum: 'Для уточнения стоимости тренинга свяжитесь с нашим консультантом'
        }
    }
  },
  {
    ...
    cost: {
      company:
        {
          consistTitle: 'В стоимость проведения тренинга “Подбор персонала: Как подобрать себе сильных сотрудников” для корпоративных Клиентов может опционно входить:',
          consist: ['Ряд мероприятий предтренинговой диагностики', 'Адаптация программы и материалов тренинга под специфику бизнеса Клиента', 'Проведение тренинга бизнес-тренером компании “Тезаурус”', 'Предоставление отчетности и обратной связи по итогам проведения тренинга', 'Ряд посттренинговых мероприятий', 'Комплект информационных материалов по теме тренинга для каждого участника'],
          sum: 'Для уточнения стоимости тренинга свяжитесь с нашим консультантом'
        },
      people: {
  ...
  },
  {
    ...
    preview: '<p>За время тренинга участники научатся:</p>\n' +
      ...
      '</p>',
    text: '<p>\n' +
      '  25% времени тренинга: теоретический материал<br>75% времени тренинга: практические упражнения, направленные на отработку навыков обучающихся\n' +
      '</p>\n' +
      '<p class="tz-sub-header">Преимущества тренинга:</p>\n' +
      '<ul>\n' +
      '  <li>Разносторонняя отработка навыков в практических упражнениях (деловая игра, бизнес-кейсы, дискуссия, мозговой штурм)\n' +
    ...
    cost: {
      company:
        {
          consistTitle: 'В стоимость проведения двухдневного тренинга “Эффективные переговоры” для корпоративных Клиентов может опционно входить:',
          consist: ['Ряд мероприятий предтренинговой диагностики', 'Адаптация программы и материалов тренинга под специфику бизнеса Клиента', 'Проведение тренинга бизнес-тренером компании “Тезаурус”', 'Предоставление отчетности и обратной связи по итогам проведения тренинга', 'Ряд посттренинговых мероприятий', 'Комплект информационных материалов по теме тренинга для каждого участника'],
          sum: 'Для уточнения стоимости тренинга свяжитесь с нашим консультантом'
        },
      people:
  ...
  },
  {
    ...
    cost: {
      company:
        {
          consistTitle: 'В стоимость проведения двухдневного тренинга «Как сделать сервис клиентоориентированным» для корпоративных Клиентов может опционно входить:',
          consist: ['Ряд мероприятий предтренинговой диагностики', 'Адаптация программы и материалов тренинга под специфику бизнеса Клиента', 'Проведение тренинга бизнес-тренером компании “Тезаурус”', 'Предоставление отчетности и обратной связи по итогам проведения тренинга', 'Ряд посттренинговых мероприятий', 'Комплект информационных материалов по теме тренинга для каждого участника'],
          sum: 'Для уточнения стоимости тренинга свяжитесь с нашим консультантом'
        }
    }
  },
  {
    ...
    text: '<p>\n' +
      ...
      '</p>\n' +
      '<p class="tz-sub-header">За время прохождения курса онлайн-тренингов участники научатся:</p>\n' +
      '<p>Определять роль руководителя в отделе и организации<br>\n' +
      '  Организовывать свое рабочее время и рабочее время подчиненных<br>\n' +
      '  Эффективно ставить задачи подчиненным<br>\n' +
      '  Правильно делегировать полномочия<br>\n' +
      ...
      '  Использовать эффективные инструменты контроля<br>\n' +
      '</p>\n' +
      '<p class="tz-sub-header">Структура материала курса онлайн-тренингов:</p>\n' +
      '<p>1. Роль руководителя</p>\n' +
      '<ul>\n' +
      '  <li>Основные функции руководителя\n' +
      '  <li>Управление и исполнение\n' +
    ...
    info: {
      ...
      duration: 'Онлайн-тренинг состоит из пяти блоков длительностью по два часа'
    },
    cost: {
      company:
        {
          consistTitle: 'В стоимость проведения курса онлайн-тренингов “Основные управленческие навыки” для корпоративных Клиентов может опционно входить:',
          consist: ['Ряд мероприятий предтренинговой диагностики', 'Адаптация программы и материалов курса под специфику бизнеса Клиента', 'Проведение курса бизнес-тренером компании “Тезаурус”', 'Предоставление отчетности и обратной связи по итогам проведения курса', 'Ряд посттренинговых мероприятий', 'Комплект информационных материалов по теме курса для каждого участника'],
